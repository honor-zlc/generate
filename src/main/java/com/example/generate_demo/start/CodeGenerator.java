package com.example.generate_demo.start;
...
public class CodeGenerator {
     ...
     * 代码生成位置
     */
    public static final String PARENT_NAME = "org.springeos.modules";
     ...
     * 作者
     */
    public static final String AUTHOR = "zlc";
    ...
    public static final String JDBC_MYSQL_URL = "jdbc:mysql://localhost:3306/besesql?" +
    ...
    public static void main(String[] args) {
        ...
        String tableNamestr = scanner("表名(多个用英文逗号隔开)");
